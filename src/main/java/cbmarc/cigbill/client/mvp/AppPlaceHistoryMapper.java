...
@WithTokenizers({ AuthPlace.Tokenizer.class, UsersPlace.Tokenizer.class,
		CustomersPlace.Tokenizer.class, InvoicesPlace.Tokenizer.class,
		PaymentsPlace.Tokenizer.class, ProductsPlace.Tokenizer.class,
		ItemsPlace.Tokenizer.class, TaxesPlace.Tokenizer.class })
